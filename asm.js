...
const commands = [
    ...
    new Command("add", [Args.B, Args.C], 0x3B),
        new Command("ldi", [Args.A], 0x30),
        new Command("ldi", [Args.B], 0x35),
        new Command("ldi", [Args.C], 0x3A),
        new Command("ldi", [Args.D], 0x3F),

    new Command("jmp", [Args.A], 0x40),
    new Command("jmp", [Args.B], 0x41),
    new Command("jmp", [Args.C], 0x42),
    new Command("jmp", [Args.D], 0x43),
        new Command("jc", [Args.A], 0x44),
        new Command("js", [Args.B], 0x45),
        new Command("jz", [Args.C], 0x46),
        new Command("jo", [Args.D], 0x47),
            new Command("jnc", [Args.A], 0x48),
            new Command("jns", [Args.B], 0x49),
            new Command("jnz", [Args.C], 0x4A),
            new Command("jno", [Args.D], 0x4B),
                new Command("nop", [], 0x4C),
                new Command("jmp", [BYTE], 0x4D),
                new Command("hlt", [], 0x4E),
                new Command("cmc", [], 0x4F),

    new Command("jc", [Args.A], 0x50),
    new Command("jc", [Args.B], 0x54),
    new Command("ic", [Args.C], 0x58),
